...
! function() {
    ...
    window.Framework7 = function(a) {
            ...
            if (o.handleTouchStart = function(e) {
                ...
                if (M) {
                    ...
                    if (!O) {
                        ...
                        p.length > 0 && (!i.rtl && p.find(".swipeout-actions-left").length > 0 && (n = !0), i.rtl && p.find(".swipeout-actions-right").length > 0 && (n = !0)), D = r.is(".page") ? r : r.parents(".page"), D.hasClass("no-swipeback") && (n = !0), E = l.find(".page-on-left:not(.cached)");
                        var d = I.x - l.offset().left > o.params.swipeBackPageActiveArea;
                        if (d = i.rtl ? I.x < l.offset().left - l[0].scrollLeft + w - o.params.swipeBackPageActiveArea : I.x - l.offset().left > o.params.swipeBackPageActiveArea, d && (n = !0), (0 === E.length || 0 === D.length) && (n = !0), n) return void(M = !1);
                    ...
                    var m = b * c,
                        h = (b / 5 - w / 5) * c;
                    if (1 === i.device.pixelRatio && (m = Math.round(m), h = Math.round(h)), D.transform("translate3d(" + m + "px,0,0)"), o.params.swipeBackPageAnimateShadow && "android" !== i.device.os && (D[0].style.boxShadow = "0px 0px 12px rgba(0,0,0," + (.5 - .5 * f) + ")"), E.transform("translate3d(" + h + "px,0,0)"), o.params.swipeBackPageAnimateOpacity && (E[0].style.opacity = .9 + .1 * f), S) {
                        var g;
                ...
                if (M = !1, O = !1, 0 === b) return s([D[0], E[0]]).transform("").css({
                    opacity: "",
                    boxShadow: ""
                ...
                var e = (new Date).getTime() - C,
                    a = !1;
                if ((300 > e && b > 10 || e >= 300 && b > w / 2) && (D.removeClass("page-on-center").addClass("page-on-right"), E.removeClass("page-on-left").addClass("page-on-center"), S && (N.removeClass("navbar-on-center").addClass("navbar-on-right"), B.removeClass("navbar-on-left").addClass("navbar-on-center")), a = !0), s([D[0], E[0]]).transform("").css({
                    opacity: "",
                    boxShadow: ""
                ...
                D.transitionEnd(function() {
                    s([D[0], E[0]]).removeClass("page-transitioning"), S && (y.removeClass("page-transitioning").css({
                        opacity: ""
        ...
        i.triggerPageCallbacks = function(e, a, t) {
            ...
            else s(i.router.temporaryDom).append(h); if (u = a.reload && (a.reloadPrevious ? "left" : "center"), n = w ? C.find('.page[data-page="' + w + '"]') : i.router.findElement(".page", i.router.temporaryDom, e), !n || 0 === n.length || w && e.activePage && e.activePage.name === w) return void(e.allowPageChange = !0);
            ...
            if (e.params.uniqueHistory) {
                ...
                if (e.params.uniqueHistoryIgnoreGetParameters)
                    for (D = [], E = m.split("?")[0], l = 0; l < e.history.length; l++) D.push(e.history[l].split("?")[0]);
                D.indexOf(E) !== D.lastIndexOf(E) && (e.history = e.history.slice(0, D.indexOf(E)), e.history.push(m), I = !0)
            }
        ...
        i.modalStack = [], i.modalStackClearQueue = function() {
            ...
            return "function" == typeof a && (n = arguments[2], t = arguments[1], a = void 0), i.modal({
                ...
                onClick: function(e, a) {
                    var r = s(e).find('.modal-text-input[name="modal-username"]').val(),
                        i = s(e).find('.modal-text-input[name="modal-password"]').val();
            ...
            var p;
            if (o) {
                var d = '<div class="popover actions-popover"><div class="popover-inner">{{#each this}}<div class="list-block"><ul>{{#each this}}{{#if label}}<li class="actions-popover-label {{#if color}}color-{{color}}{{/if}} {{#if bold}}actions-popover-bold{{/if}}">{{text}}</li>{{else}}<li><a href="#" class="item-link list-button {{#if color}}color-{{color}}{{/if}} {{#if bg}}bg-{{bg}}{{/if}} {{#if bold}}actions-popover-bold{{/if}}">{{text}}</a></li>{{/if}}{{/each}}</ul></div>{{/each}}</div></div>';
            ...
            function t(e) {
                if (r) {
                    ...
                    var E;
                    if (u.length > 0)
                        for (D = v / g, -g > v && (v = -g - Math.pow(-v - g, .8), k.length > 0 && (P = !0)), n = 0; n < y.length; n++) "undefined" == typeof y[n]._buttonOffset && (y[n]._buttonOffset = y[n].offsetLeft), p = y[n]._buttonOffset, E = s(y[n]), k.length > 0 && E.hasClass("swipeout-overswipe") && E.css({
                            left: (P ? -p : 0) + "px"
                        }), E.transform("translate3d(" + (v - p * (1 + Math.max(D, -1))) + "px,0,0)");
                    if (m.length > 0)
                        for (D = v / h, v > h && (v = h + Math.pow(v - h, .8), T.length > 0 && (S = !0)), n = 0; n < C.length; n++) "undefined" == typeof C[n]._buttonOffset && (C[n]._buttonOffset = h - C[n].offsetLeft - C[n].offsetWidth), p = C[n]._buttonOffset, E = s(C[n]), T.length > 0 && E.hasClass("swipeout-overswipe") && E.css({
                            left: (S ? p : 0) + "px"
                        }), C.length > 1 && E.css("z-index", C.length - n), E.transform("translate3d(" + (v + p * (1 - Math.min(D, 1))) + "px,0,0)");
            ...
            function a(a) {
                ...
                s(a).on("change", 'input[name="' + I + '"]', function() {
                    ...
                    v.trigger("change"), e.find(".item-after").text(o.join(", ")), c && "radio" === O && ("popup" === r ? i.closeModal(F) : n.router.back())
                })
            }
            ...
            if (e = s(e), 0 !== e.length) {
                ...
                if (0 !== n.length && (n = n[0].f7View)) {
                    ...
                    if (!(g.disabled || e.hasClass("disabled") || v.hasClass("disabled"))) {
                        for (var w, b, C, y, x, T, k, S, P = [], M = (new Date).getTime(), O = g.multiple ? "checkbox" : "radio", I = O + "-" + M, D = 0; D < g.length; D++) w = s(g[D]), w[0].disabled || (C = w.attr("data-option-image") || v.attr("data-option-image"), y = w.attr("data-option-icon") || v.attr("data-option-icon"), b = C || y || "checkbox" === O, x = w.parent("optgroup")[0], T = x && x.label, k = !1, x && x !== S && (k = !0, S = x), P.push({
                            value: w[0].value,
                        ...
                        var E = i._compiledTemplates.smartSelectItem,
                            L = "";
                        if (!m)
                            for (var N = 0; N < P.length; N++) L += E(P[N]);
                        ...
                        var R, V, q = "smart-select-" + I,
                            G = "undefined" == typeof e.data("searchbar") ? i.params.smartSelectSearchbar : "true" === e.data("searchbar") ? !0 : !1;
                        G && (R = e.data("searchbar-placeholder") || "Search", V = e.data("searchbar-cancel") || "Cancel");
                        var F, W = '<form class="searchbar" data-search-list=".smart-select-list-' + M + '" data-search-in=".item-title"><div class="searchbar-input"><input type="search" placeholder="' + R + '"><a href="#" class="searchbar-clear"></a></div><a href="#" class="searchbar-cancel">' + V + '</a></form><div class="searchbar-overlay"></div>',
                            Y = ("through" === B ? A : "") + '<div class="pages">  <div data-page="' + q + '" class="page smart-select-page ' + z + " " + H + '">' + ("fixed" === B ? A : "") + (G ? W : "") + '    <div class="page-content">' + ("static" === B ? A : "") + '      <div class="list-block ' + (m ? "virtual-list" : "") + " smart-select-list-" + M + " " + (f ? "theme-" + f : "") + '">        <ul>' + (m ? "" : L) + "        </ul>      </div>    </div>  </div></div>";
                        "popup" === r ? (F = i.popup('<div class="popup smart-select-popup smart-select-popup-' + I + '"><div class="view navbar-fixed">' + Y + "</div></div>"), i.initPage(s(F).find(".page")), a(F)) : (s(document).on("pageInit", t), n.router.load({
                            content: Y
                        }))
                    }
                }
        ...
        i.virtualList = function(e, a) {
            ...
            if (l.hasClass("pull-to-refresh-content") || (l = l.find(".pull-to-refresh-content")), l && 0 !== l.length) {
                var p, d, c, f, u, m, h, g, v, w, b, C = {}, y = !1,
                    x = !1,
                    T = 0,
            ...
            function u(n) {
                ...
                i.device.android && r(n.target) && document.activeElement.blur(), x = !0, y = n.target, C = (new Date).getTime(), w = n.targetTouches[0].pageX, b = n.targetTouches[0].pageY, i.device.ios && (k = void 0, s(y).parents().each(function() {
                    var e = this;
            ...
            function h(e) {
                if (clearTimeout(O), !x) return !T && I && (!i.device.android || e.cancelable) && e.preventDefault(), !0;
                ...
                if (S = e.timeStamp, x = !1, i.device.ios && k && k.scrollTop !== k.f7ScrollTop) return !1;
                ...
                var a = e.changedTouches[0],
                    ...
                    o = "click";
                return i.device.android && "select" === y.nodeName.toLowerCase() && (o = "mousedown"), r.initMouseEvent(o, !0, !0, window, 1, a.screenX, a.screenY, a.clientX, a.clientY, !1, !1, !1, !1, 0, null), r.forwardedTouchEvent = !0, y.dispatchEvent(r), !1
            }
            ...
            var a = {}, t = ["submit", "image", "button", "file"],
                n = [];
        ...
        var m = function(e) {
            ...
            var o = "dark" === t.params.theme ? "color-white" : "",
                ...
                p = t.params.toolbarTemplate || '<div class="toolbar tabbar"><div class="toolbar-inner"><a href="#" class="link photo-browser-prev"><i class="icon icon-prev ' + o + '"></i></a><a href="#" class="link photo-browser-next"><i class="icon icon-next ' + o + '"></i></a></div></div>',
            ...
            var M, O, I, D, E, L, N, B, A, z, H, R, V, q, G, F, W, Y = {}, j = {};
            t.onSlideTouchStart = function(e) {
                ...
                if (x && 0 !== x.length && (t.swiper.allowClick = !1, M && y)) {
                    ...
                    if (!(a < t.swiper.width && n < t.swiper.height)) {
                        if (E = Math.min(t.swiper.width / 2 - a / 2, 0), N = -E, L = Math.min(t.swiper.height / 2 - n / 2, 0), B = -L, j.x = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX, j.y = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, !O && !P && (Math.floor(E) === Math.floor(H) && j.x < Y.x || Math.floor(N) === Math.floor(H) && j.x > Y.x)) return void(M = !1);
                        e.preventDefault(), e.stopPropagation(), O = !0, I = j.x - Y.x + H, D = j.y - Y.y + R, E > I && (I = E + 1 - Math.pow(E - I + 1, .8)), I > N && (I = N - 1 + Math.pow(I - N + 1, .8)), L > D && (D = L + 1 - Math.pow(L - D + 1, .8)), D > B && (D = B - 1 + Math.pow(D - B + 1, .8)), V || (V = j.x), F || (F = j.y), q || (q = Date.now()), G = (j.x - V) / (Date.now() - q) / 2, W = (j.y - F) / (Date.now() - q) / 2, Math.abs(j.x - V) < 2 && (G = 0), Math.abs(j.y - F) < 2 && (W = 0), V = j.x, F = j.y, q = Date.now(), T.transform("translate3d(" + I + "px, " + D + "px,0)")
                    }
                }
                ...
                if (x && 0 !== x.length) {
                    ...
                    var e = 300,
                        ...
                        i = W * a,
                        o = D + i;
                    0 !== G && (e = Math.abs((r - I) / G)), 0 !== W && (a = Math.abs((o - D) / W));
                    var s = Math.max(e, a);
                    I = r, D = o;
                    var l = A * k,
                        p = z * k;
                    E = Math.min(t.swiper.width / 2 - l / 2, 0), N = -E, L = Math.min(t.swiper.height / 2 - p / 2, 0), B = -L, I = Math.max(Math.min(I, N), E), D = Math.max(Math.min(D, B), L), T.transition(s).transform("translate3d(" + I + "px, " + D + "px,0)")
                }
            };
            var _, X, U, J, Q, K = !1,
                Z = !0,
            ...
            return p.setValue = function(e, a) {
                ...
                function r(e) {
                    if (C) {
                        ...
                        var a = T - x;
                        O = P + a, M = void 0, v > O && (O = v - Math.pow(v - O, .8), M = "min"), O > w && (O = w + Math.pow(O - w, .8), M = "max"), u.wrapper.transform("translate3d(0," + O + "px,0)"), u.updateItems(void 0, O, 0, p.params.updateValuesOnTouchmove), D = O - I || O, E = (new Date).getTime(), I = O
                    }
                }
                ...
                function o() {
                    ...
                    var e, a;
                    S - k > 300 ? a = O : (e = Math.abs(D / (S - E)), a = O + D * p.params.momentumRatio), a = Math.max(Math.min(a, w), v);
                ...
                if (!u.divider) {
                    ...
                    var C, y, x, T, k, S, P, M, O, I, D, E, L = !0;
        ...
        i.addNotification = function(e) {
            if (e) {
                ...
                t = e.custom ? "<li>" + e.custom + "</li>" : '<li class="notification-item notification-hidden"><div class="item-content">' + (e.media ? '<div class="item-media">' + e.media + "</div>" : "") + '<div class="item-inner"><div class="item-title-row">' + (e.title ? '<div class="item-title">' + e.title + "</div>" : "") + (e.closeIcon ? '<div class="item-after"><a href="#" class="close-notification"><span></span></a></div>' : "") + "</div>" + (e.subtitle ? '<div class="item-subtitle">' + e.subtitle + "</div>" : "") + (e.message ? '<div class="item-text">' + e.message + "</div>" : "") + "</div></div></li>", v.innerHTML = t;
                var r = s(v).children();
    ...
    var e = function() {
        ...
        return a.ajax = function(e) {
            ...
            }("GET" === p || "HEAD" === p) && e.cache === !1 && (e.url += e.url.indexOf("?") >= 0 ? "&_nocache=" + Date.now() : "?_nocache=" + Date.now());
            ...
            return v.onload = function() {
                ...
                v.abort(), r("ajaxError", {
                    xhr: v,
                    timeout: !0
                }, "error", v, "timeout"), r("ajaxComplete", {
                    xhr: v,
                    timeout: !0
                }, "complete", v, "timeout")
            }, e.timeout)), v
    ...
    window.Dom7 = e, Framework7.prototype.support = function() {
        ...
        if (f = "undefined" == typeof e ? window.Dom7 || window.Zepto || window.jQuery : e, f && (c.container = f(a), 0 !== c.container.length)) {
            ...
            c.container[0].swiper = c, c.container.data("swiper", c), c.container.addClass("swiper-container-" + c.params.direction), c.params.freeMode && c.container.addClass("swiper-container-free-mode"), ["cube", "coverflow"].indexOf(c.params.effect) >= 0 && (c.support.transforms3d ? (c.params.watchSlidesProgress = !0, c.container.addClass("swiper-container-3d")) : c.params.effect = "slide"), "slide" !== c.params.effect && c.container.addClass("swiper-container-" + c.params.effect), "cube" === c.params.effect && (c.params.resistanceRatio = 0, c.params.slidesPerView = 1, c.params.slidesPerColumn = 1, c.params.slidesPerGroup = 1, c.params.centeredSlides = !1, c.params.spaceBetween = 0), "fade" === c.params.effect && (c.params.watchSlidesProgress = !0, c.params.spaceBetween = 0), c.params.grabCursor && c.support.touch && (c.params.grabCursor = !1), c.wrapper = c.container.children("." + c.params.wrapperClass), c.params.pagination && (c.paginationContainer = f(c.params.pagination), c.params.paginationClickable && c.paginationContainer.addClass("swiper-pagination-clickable")), c.rtl = n() && ("rtl" === c.container[0].dir.toLowerCase() || "rtl" === c.container.css("direction")), c.rtl && c.container.addClass("swiper-container-rtl"), c.rtl && (c.wrongRTL = "-webkit-box" === c.wrapper.css("display")), c.translate = 0, c.progress = 0, c.velocity = 0, c.lockSwipeToNext = function() {
                ...
                }), c.params.slidesPerColumn > 1 && (c.virtualWidth = (s + c.params.spaceBetween) * o, c.virtualWidth = Math.ceil(c.virtualWidth / c.params.slidesPerColumn) - c.params.spaceBetween, c.wrapper.css({
                    width: c.virtualWidth + c.params.spaceBetween + "px"
                ...
                if ("undefined" == typeof e && (e = c.translate || 0), 0 !== c.slides.length) {
                    ...
                    c.rtl && (a = c.params.centeredSlides ? e - c.size / 2 : e); {
                ...
                c.updateContainerSize(), c.updateSlidesSize(), c.updateProgress(), c.updateClasses(), "auto" === c.params.slidesPerView && c.updatePagination(), c.isEnd ? c.slideTo(c.slides.length - 1, 0, !1, !0) : c.slideTo(c.activeIndex, 0, !1, !0), c.params.scrollbar && c.scrollbar && c.scrollbar.init()
            };
            ...
            window.navigator.pointerEnabled ? u = ["pointerdown", "pointermove", "pointerup"] : window.navigator.msPointerEnabled && (u = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), c.touchEvents = {
                ...
                var a = e ? "off" : "on",
                    ...
                    n = "container" === c.params.touchEventsTarget ? c.container : c.wrapper,
                    r = c.support.touch ? n : f(document),
                    i = c.params.nested ? !0 : !1;
                n[0][t](c.touchEvents.start, c.onTouchStart, !1), r[0][t](c.touchEvents.move, c.onTouchMove, i), r[0][t](c.touchEvents.end, c.onTouchEnd, !1), window[t]("resize", c.onResize), c.params.nextButton && f(c.params.nextButton)[a]("click", c.onClickNext), c.params.prevButton && f(c.params.prevButton)[a]("click", c.onClickPrev), c.params.pagination && c.params.paginationClickable && f(c.paginationContainer)[a]("click", "." + c.params.bulletClass, c.onClickIndex), (c.params.preventClicks || c.params.preventClicksPropagation) && n[0][t]("click", c.preventClicks, !0)
            }, c.attachEvents = function() {
                c.events()
            }, c.detachEvents = function() {
                c.events(!0)
            }, c.allowClick = !0, c.preventClicks = function(e) {
                c.allowClick || (c.params.preventClicks && e.preventDefault(), c.params.preventClicksPropagation && (e.stopPropagation(), e.stopImmediatePropagation()))
                ...
                if (!a) return c.clickedSlide = void 0, void(c.clickedIndex = void 0);
                if (c.clickedSlide = a, c.clickedIndex = f(a).index(), c.params.slideToClickedSlide && void 0 !== c.clickedIndex && c.clickedIndex !== c.activeIndex) {
            ...
            var m, h, g, v, w, b, C, y = {}, x = {};
            c.animating = !1;
            var T, k, S = Date.now(),
                P = [],
                M = "input, select, textarea, button";
            return c.onTouchStart = function(e) {
                if (e.originalEvent && (e = e.originalEvent), !("mousedown" === e.type && "which" in e && 3 === e.which || c.params.noSwiping && o(e, "." + c.params.noSwipingClass) || c.params.swipeHandler && !o(e, c.params.swipeHandler))) {
                    if (m = !0, h = !1, v = void 0, y.x = x.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, y.y = x.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, g = Date.now(), c.allowClick = !0, c.updateContainerSize(), c.swipeDirection = void 0, c.params.threshold > 0 && (C = !1), "touchstart" !== e.type) {
                        var a = !0;
                ...
                if (e.originalEvent && (e = e.originalEvent), m) {
                    ...
                    var I, D = 0,
                        E = c.slidesSizesGrid[0];
                    for (I = 0; I < c.slidesGrid.length; I += c.params.slidesPerGroup) "undefined" != typeof c.slidesGrid[I + c.params.slidesPerGroup] ? i >= c.slidesGrid[I] && i < c.slidesGrid[I + c.params.slidesPerGroup] && (D = I, E = c.slidesGrid[I + c.params.slidesPerGroup] - c.slidesGrid[I]) : i >= c.slidesGrid[I] && (D = I, E = c.slidesGrid[c.slidesGrid.length - 1] - c.slidesGrid[c.slidesGrid.length - 2]);
                    var L = (i - c.slidesGrid[D]) / E;
                    if (t > c.params.longSwipesMs) {
                        if (!c.params.longSwipes) return void c.slideTo(c.activeIndex);
                        "next" === c.swipeDirection && c.slideTo(L >= c.params.longSwipesRatio ? D + c.params.slidesPerGroup : D), "prev" === c.swipeDirection && c.slideTo(L > 1 - c.params.longSwipesRatio ? D + c.params.slidesPerGroup : D)
                    } else {
                        if (!c.params.shortSwipes) return void c.slideTo(c.activeIndex);
                        "next" === c.swipeDirection && c.slideTo(D + c.params.slidesPerGroup), "prev" === c.swipeDirection && c.slideTo(D)
                    }
                }
                    ...
                    setTranslate: function() {
                        ...
                        for (var t = 0; t < c.slides.length; t++) {
                            var r = c.slides.eq(t),
                                i = 90 * t,
                                o = Math.floor(i / 360);
                            c.rtl && (i = -i, o = Math.floor(-i / 360));
                            var s = Math.max(Math.min(r[0].progress, 1), -1),
                                l = 0,
                                p = 0,
                                d = 0;
                            t % 4 === 0 ? (l = 4 * -o * c.size, d = 0) : (t - 1) % 4 === 0 ? (l = 0, d = 4 * -o * c.size) : (t - 2) % 4 === 0 ? (l = c.size + 4 * o * c.size, d = c.size) : (t - 3) % 4 === 0 && (l = -c.size, d = 3 * c.size + 4 * c.size * o), c.rtl && (l = -l), n() || (p = l, l = 0);
                            var u = "rotateX(" + (n() ? 0 : -i) + "deg) rotateY(" + (n() ? i : 0) + "deg) translate3d(" + l + "px, " + p + "px, " + d + "px)";
                            if (1 >= s && s > -1 && (a = 90 * t + 90 * s, c.rtl && (a = 90 * -t - 90 * s)), r.transform(u), c.params.cube.slideShadows) {
