...
<div class="btn-group pull-right page-menu">
    ...
    <div rel="open-modal" data-script="checklist_job/add_job.php?id=<?=$id?>" class="btn btn-success" title="Add Checklist Job" tooltip>
        <i class="icon-plus"></i>
    </div>
</div>
        ...
        <td>
          <table class="data-table-header" cellpadding="0" cellspacing="0" border="0">
            <tr valign='center' >
              ...
              ?>
              <input type="button" value="Set Order" class="btn btn-blue pull-right"  data-script="checklist_job_order.php?id=<?=$id?>" rel="open-modal" ></input>
              </td>
            </tr>
          </table>
        </td>
      ...
      <tr>
        <td>
          ...
          <script type='text/javascript'>
            Request.make('<?=AJAX_DIR?>/checklist_job/get_joblist.php?id=<?=$id?>', 'knowledgebasecontainer', true, true);
          </script>
        </td>
      </tr>
    </table>
          ...
          else
          {
              ...
              for(var i=0;i<myObj.joblist.length;i++)
              {
                ...
                if(i%2==0)
                  ...
                  p+="<td width='60%'>";
                  p+="<a href='javascript: Request.make(\"includes/ajax/checklist_job/get_joblist.php?";
                  ...
                  p+="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:if(confirm(\"Are you sure?\")) Request.make(\"includes/ajax/checklist_job/get_joblist.php?id=<?=$id?>&checklist_job_id=";
