...
<table class="data-table-header" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 50px;">
    ...
    <tr valign="center">
        ...
        <td align="center" style="font-size: 30px;padding: 10px;">Code Generator Job Details</td>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%" align="center" class="infocontainernopadding">
   ...
   <?php $sql = "select tbl_codegenerator_job_id,codegenerator_id,name,attachment,description,attachment_desc from tbl_codegenerator_job where tbl_codegenerator_job_id='{$codegenerator_job_id}' ";
  ...
  {
    $filepath=ROOT_DIR."/docs/codegenerator/";
