...
if(RequestUtil::get("submit")) 
{
    if(empty($name)) 
    {
        $errors[] = 'Checklist Job name cannot be blank';
    }
    ...
    if(!count($errors)) 
    {
      ...
      $sql = "INSERT INTO tbl_checklist_job (account_id,name,checklist_id,description,attachment,attachment_desc, created_by,created_at,is_deleted)
              VALUES ('{$_SESSION['ao_accountid']}','$name', '$checklist_id','$description','$attachment_file_names', 
      ...
      <script>
        $(document).ready(function()
        {
            try{
               ...
               opener.location.href="<?=ROOT_DIR?>/check-list-job.php?id=<?=$id?>";
