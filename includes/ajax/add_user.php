...
<form method="post" name="user" action="?">
  ...
  <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center" class="infocontainernopadding">
    ...
    <tr valign="top">
        ...
        <td class="listrow email_wrapper">
    ...
    var wrapper = $('.email_wrapper'); //Input field wrapper
    var fieldHTML = '<div><input type="text" name="email[]" value=""/><a href="javascript:void(0);" class="remove_button"><button type="button" class="btn btn-danger">Remove</button></a></div>'; //New input field html 
