...
$midroof_timing = RequestUtil::get('midroof_timing');
$midroof = $midroof_timing ? 1 : 0;
$length = RequestUtil::get('length');
$ladder = RequestUtil::get('ladder');
...
if (RequestUtil::get("submit")) {
    ...
    if (!count($errors)) {
        $sql = "INSERT INTO jurisdiction
            ...
            DBUtil::query($sql);
             $lastid=DBUtil::getInsertId();

            $sql = "INSERT INTO jurisdiction_additionals
                VALUES (NULL, '$lastid', '{$website_of_jurisdiction}', '{$roofing_handout}', '{$phone_number_of_jurisdiction}', '{$email_of_jurisdiction}', '{$code_enforced}', '{$codevalue}', '{$link_to_code_book_irc}', '{$commercial_ibc}', 
...
<script>
    parent.window.location.href = '/jurisdictions.php';
</script>
<?php
        die();
    }
...
?>
<form method="post" name="jurisdiction" action="?">
<table class="data-table-header" cellpadding="0" cellspacing="0" border="0">
    <tr>
        <td>New Jurisdiction</td>
        <td align="right">
...
?>">
    ...
    <tr>
        ...
        <td class="listrow">
            <input name="midroof_timing" type="text" value="<?=$midroof_timing?>">
        </td>
    </tr>
    <tr>
...
?>
    ...
    <tr>
        ...
        <td class="listrow">
            <input name="length" type="text" value="<?=$length
?>"> days
        </td>
    </tr>
