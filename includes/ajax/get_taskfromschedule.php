...
?>
            ...
            <tr>
              ...
              <td class="listrow"><?=DateUtil::formatDate($myTask->timestamp)?></td>
            </tr>
            <tr>
...
?>
            ...
            <tr>
              ...
              <td class="listrow">
                  <?=($myTask->start_date==''||$myTask->start_date=='NULL') ? '<font color="red">Not Scheduled</font>' : $myTask->start_date ?>
              </td>
            </tr>
            <tr valign='top'>
            ...
            <tr>
              <td align="right" colspan=2 class="listrow">
                <input type='button' value='Go to Job' onclick="parent.location='<?=ROOT_DIR?>/jobs.php?id=<?=$myTask->job_id?>';">
              </td>
            </tr>
          </table>
        </td>
