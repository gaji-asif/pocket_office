...
?>
        ...
        <td style='font-size: 35px; font-weight: bold;' width=800 align="right">Job Profitability</td>
      </tr>
    </table>
    <br><br>
      ...
      <tr valign='top'>
        <td style='border-left: 1px solid black; border-bottom: 1px solid black; border-right: 1px solid black;'>
          <table border="0" width="100%" cellspacing="0" cellpadding=2>
            ...
            <tr class='odd'>
              <td align="right" style='font-size: 16px;'><b><?php echo $commission_percentage; ?>% Commission TBP:</b></td>
              <td width=100 style='font-size: 16px;'><?php echo $commission; ?></td>
            </tr>
            <tr class='odd'>
              <td align="right" style='font-size: 20px;'><b>Net Profit:</b></td>
              <td width=100 style='font-size: 20px;'><?php echo $net; ?></td>
            </tr>
          </table>
        </td>
      </tr>
