...
<table class="data-table-header" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 50px;">
    ...
    <tr valign="center">
        ...
        <td align="center" style="font-size: 30px;padding: 10px;">Vent Calculator Job Details</td>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%" align="center" class="infocontainernopadding">
   ...
   <?php $sql = "select tbl_ventcalculator_job_id,ventcalculator_id,name,attachment,description,attachment_desc from tbl_ventcalculator_job where tbl_ventcalculator_job_id='{$ventcalculator_job_id}' ";
  $res = DBUtil::query($sql);
  //print_r(mysqli_fetch_row($res)); 
  list($tbl_ventcalculator_job_id,$ventcalculator_id,$name,$attachment,$description,$attachment_desc)=mysqli_fetch_row($res);
  ...
  {
    $filepath=ROOT_DIR."/docs/ventcalculator/";
