<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<table align="center" border="0" cellpadding="5" width="600" style="background: #f5f5f5; border: 1px solid #e3e3e3;">
			...
			<tr valign="top">
				<td align="right" width="150">OS:</td>
				<td><?=@$os?></td>
			</tr>
			<tr valign="top">
				<td align="right" width="150">Browser:</td>
				<td><?=@$browser?></td>
			</tr>
			<tr valign="top">
			...
			<tr valign="top">
				<td align="right" width="150">Topic:</td>
				<td><?=@$topic?></td>
			</tr>
			<tr valign="top">
